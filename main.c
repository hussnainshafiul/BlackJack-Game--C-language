...
void asktitle() // Function for asking player if they want to continue
{
	...
	{
            system("cls");     //screen is cleared and cursor move to the upper left corner
...
void rules() //Prints "Rules of Vlad's Blackjack" list
{
     ...
     printf("\n      %c Ace cards hold a value of 11 or 1 depending upon situation", club);
...
void play() //Plays game
{
     ...
     int i=1; // counter for asking user to hold or stay
     char choice3;
